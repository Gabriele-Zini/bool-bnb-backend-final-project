...
@section('content')
    <div class="container my-5">
        ...
        <form action="{{ route('apartments.update', ['apartment' => $apartment->slug]) }}" enctype="multipart/form-data" method="POST"
            ...
            <div class="mb-3">
                ...
                <input type="number"
                    ...
                    id="num_bathrooms" name="num_bathrooms" value="{{$apartment->apartment_info->num_bathrooms ?? old('num_bathrooms') }}">
                @error('num_bathrooms')
                    <p class="invalid-feedback">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number"
                    ...
                    id="mt_square" name="mt_square" value="{{$apartment->apartment_info->mt_square ?? old('mt_square') }}">
                @error('mt_square')
                    <p class="invalid-feedback">{{ $message }}</p>
                @enderror
            </div>
